  ...
  return (
    <BackgroundContainer>
      ...
      <div className="mx-auto space-y-6 py-12">
        <h1 className="text-3xl font-bold">Shothik AI Terms and Conditions</h1>
        ...
        <div className="space-y-4">
          <h2 className="text-2xl font-semibold">6. Payment for Services</h2>
          <p className="text-base leading-relaxed">
      ...
      <div className="mx-auto space-y-6 border-t py-12">
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-4">
            <h2 className="text-2xl font-semibold">8. Payment and Billing</h2>
          ...
          <div className="space-y-4">
            <h2 className="text-2xl font-semibold">9. Data and Privacy</h2>
            <p className="text-base leading-relaxed">
          ...
          <div className="space-y-4">
            <h2 className="text-2xl font-semibold">17. General Provisions</h2>
          ...
          <div className="space-y-4">
            <h2 className="text-2xl font-semibold">18. Meta-Specific Terms</h2>
            <p className="text-base leading-relaxed">
      ...
      {/* Footer */}
      <div className="mt-10 border-t py-6 text-center text-sm">
