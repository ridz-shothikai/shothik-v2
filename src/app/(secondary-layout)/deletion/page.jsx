    ...
    <BackgroundContainer>
      ...
      <div className="mx-auto space-y-6 py-12">
        ...
        <div className="space-y-8">
          ...
          <div className="space-y-4">
            <h2 className="text-2xl font-semibold">1. Data Deletion Methods</h2>
            <p className="text-base leading-relaxed">
            ...
            <div className="ml-4 space-y-6">
              ...
              <div className="space-y-3">
                ...
                <p className="text-base leading-relaxed text-yellow-600">
          ...
          <div className="space-y-4">
            <h2 className="text-2xl font-semibold">2. Data Deletion Scope</h2>
            <p className="text-base leading-relaxed">
          ...
          <div className="space-y-4">
            ...
            <div className="rounded-lg border border-yellow-500/25 bg-yellow-500/5 p-4">
              <p className="text-base leading-relaxed font-semibold text-yellow-800">
                Important Retention Information:
              </p>
              <ul className="mt-2 ml-4 list-inside list-disc space-y-2 text-yellow-700">
                <li>
          ...
          <div className="space-y-4">
            <h2 className="text-2xl font-semibold">4. Confirmation Process</h2>
            <p className="text-base leading-relaxed">
          ...
          <div className="space-y-4">
            <h2 className="text-2xl font-semibold">5. Third-Party Data</h2>
            <p className="text-base leading-relaxed">
      ...
      <div className="mt-8 border-t py-6 text-center text-sm">
        ...
        <p className="mt-2">
          This Data Deletion Policy is part of our Terms of Service and Privacy
          Policy.
        </p>
