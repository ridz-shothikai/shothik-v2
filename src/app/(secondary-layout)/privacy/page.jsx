  ...
  return (
    <BackgroundContainer>
      ...
      <div className="mx-auto space-y-6 py-12">
        <h1 className="text-3xl font-bold">Shothik AI Privacy Policy</h1>
        ...
        <div className="space-y-8">
          ...
          <div className="space-y-4">
            <h2 className="text-2xl font-semibold">8. Disclosure of Data</h2>
            <p className="text-base leading-relaxed">
          ...
          <div className="space-y-4">
            <h2 className="text-2xl font-semibold">9. Security of Data</h2>
            <p className="text-base leading-relaxed">
          ...
          <div className="space-y-4">
            <h2 className="text-2xl font-semibold">13. Service Providers</h2>
            <p className="text-base leading-relaxed">
          ...
          <div className="space-y-4">
            <h2 className="text-2xl font-semibold">14. Analytics</h2>
            <p className="text-base leading-relaxed">
          ...
          <div className="space-y-4">
            <h2 className="text-2xl font-semibold">15. CI/CD tools</h2>
            <p className="text-base leading-relaxed">
          ...
          <div className="space-y-4">
            <h2 className="text-2xl font-semibold">17. Payments</h2>
            <p className="text-base leading-relaxed">
          ...
          <div className="space-y-4">
            <h2 className="text-2xl font-semibold">18. Links to Other Sites</h2>
            <p className="text-base leading-relaxed">
          ...
          <div className="space-y-4">
            <h2 className="text-2xl font-semibold">19. Children's Privacy</h2>
            <p className="text-base leading-relaxed">
          ...
          <div className="space-y-4">
            <h2 className="text-2xl font-semibold">21. Contact Us</h2>
            <p className="text-base leading-relaxed">
      ...
      <div className="mx-auto space-y-6 border-t py-12">
        <h1 className="text-3xl font-bold">
          Shothik AI Marketing Automation - Privacy Policy
        </h1>
        <div className="space-y-8">
          <div className="space-y-4">
            <p className="text-base leading-relaxed">
            ...
            <p className="text-base leading-relaxed">
              Our privacy policy fully complies with Meta Platform Terms, GDPR,
              and CCPA.
            </p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <ul className="ml-4 list-inside list-disc space-y-2">
              <li>User account information (email, encrypted credentials)</li>
              <li>
                Facebook/Meta business data (ad accounts, campaigns, metrics)
              </li>
              <li>Public competitor data from Meta Ad Library API</li>
              <li>AI-generated content (campaigns, ad copy, media)</li>
          ...
          <div className="space-y-4">
            ...
            <p className="text-base leading-relaxed">Your data is used for:</p>
            <ul className="ml-4 list-inside list-disc space-y-2">
              <li>
                Creating and managing Facebook/Instagram advertising campaigns
              </li>
          ...
          <div className="space-y-4">
            ...
            <ul className="ml-4 list-inside list-disc space-y-2">
              <li>
                <strong>Right to Access</strong> - Request copy of all personal
                data we hold
              </li>
              <li>
                <strong>Right to Deletion</strong> - Complete removal of your
                data within 30 days
              </li>
              <li>
              ...
              <li>
                <strong>Right to Object</strong> - Object to specific data
          ...
          <div className="space-y-4">
            <h2 className="text-2xl font-semibold">4. Data Deletion</h2>
            <p className="text-base leading-relaxed">
              You can delete your data through multiple methods:
            </p>
            <ul className="ml-4 list-inside list-disc space-y-2">
              <li>
                <strong>Via Facebook Settings:</strong> Facebook Settings → Apps
                and Websites → Remove App
              </li>
              <li>
                <strong>Email Request:</strong> Send deletion request to
                support@shothik.ai
              </li>
              <li>
                <strong>Automated Endpoint:</strong> Use our HMAC-SHA256
                verified callback endpoint
              </li>
              <li>
                <strong>Platform Dashboard:</strong> Delete account directly
                from your settings
              </li>
            </ul>
          ...
          <div className="space-y-4">
            ...
            <ul className="ml-4 list-inside list-disc space-y-2">
              <li>
                <strong>Meta Platforms:</strong> Graph API, Ad Library API for
                Facebook/Instagram integration
              </li>
              <li>
                <strong>Google Cloud:</strong> Gemini AI, Vertex AI for
                artificial intelligence services
              </li>
              <li>
                <strong>MongoDB Atlas:</strong> Encrypted cloud database storage
              </li>
              <li>
                <strong>ImageKit:</strong> Media optimization and CDN services
              </li>
              <li>
              ...
              <li>
                <strong>Redis Cloud:</strong> Caching and session management
              </li>
            </ul>
            <div className="border-primary/25 bg-primary/5 mt-4 rounded-lg border p-4">
              ...
              <p className="text-primary mt-2 text-base leading-relaxed">
                We do not sell, trade, or rent your personal data to third
                parties. Data is only shared with service providers necessary
          ...
          <div className="space-y-4">
            <h2 className="text-2xl font-semibold">7. Compliance Standards</h2>
            <p className="text-base leading-relaxed">
              Our platform adheres to strict compliance standards:
            </p>
            <ul className="ml-4 list-inside list-disc space-y-2">
              <li>
                <strong>Meta Platform Terms:</strong> Full compliance with
                Facebook/Meta developer policies
              </li>
              <li>
                <strong>Meta Advertising Policies:</strong> Adherence to all
              ...
              <li>
                ...
                California privacy rights and obligations
              </li>
              <li>
                <strong>SOC 2 Type II:</strong> Security, availability, and
                confidentiality standards
              </li>
              <li>
                <strong>Data Processing Agreements:</strong> Signed DPAs with
                all sub-processors
              </li>
            </ul>
          </div>
          ...
          <div className="space-y-4">
            ...
            <ul className="ml-4 list-inside list-disc space-y-2">
              ...
              <li>
                <strong>Inactive Accounts:</strong> Data deleted after 24 months
                of inactivity
              </li>
              <li>
                <strong>Legal Requirements:</strong> Certain data retained to
                comply with legal obligations
              </li>
              <li>
                <strong>Backup Data:</strong> Encrypted backups retained for 30
                days
              </li>
            </ul>
          </div>
          ...
          <div className="space-y-4">
            ...
            <ul className="ml-4 list-inside list-disc space-y-2">
              ...
              <li>Data encryption during international transfers</li>
              <li>Jurisdiction-specific data protection measures</li>
            </ul>
          </div>

          <div className="space-y-4">
            <h2 className="text-2xl font-semibold">10. Contact & Support</h2>
            <p className="text-base leading-relaxed">
            ...
            <div className="mt-3 space-y-2">
              ...
              <p className="text-base leading-relaxed">
                ...
                <a href="mailto:dpo@shothik.ai" className="text-primary">
                  dpo@shothik.ai
                </a>
              </p>
            </div>
            <p className="mt-4 text-base leading-relaxed">
              We respond to all privacy inquiries within 72 hours and data
              deletion requests within 30 days as required by law.
            </p>
          </div>
        </div>
      </div>
      ...
      {/* Footer */}
      <div className="mt-8 border-t py-6 text-center text-sm">
        <p>©️ 2025 Shothik AI Marketing Automation. All rights reserved.</p>
        <p className="mt-2">
          This Privacy Policy is part of our Terms of Service and is legally
          binding.
        </p>
      </div>
    </BackgroundContainer>
