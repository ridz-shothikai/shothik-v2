  ...
  return (
    <BackgroundContainer>
      ...
      <Box>
        ...
        <p>
          <b>SERVICE</b> means the Shothik.ai website operated by {full_name}.
        </p>
        <p>
        ...
        <p>
          ...
          agreements,{" "}
          <a href={`${process.env.NEXT_PUBLIC_FRONTEND_URL}/privacy`}>
            NDA agreements
          </a>
        ...
        <p>{full_name} uses the collected data for various purposes:</p>
        ...
        <p>
          ...
          please send your request(s) by email: <b>support@shothik.ai</b>.
        </p>
        <p>
