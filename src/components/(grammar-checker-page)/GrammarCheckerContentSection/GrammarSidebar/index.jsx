...
const GrammarSidebar = ({ handleAccept, handleIgnore, handleAcceptAll }) => {
  ...
  return (
    <div className="h-full w-full flex-1 self-stretch overflow-y-auto rounded-lg border lg:mt-10 lg:w-80">
          ...
          {tabs?.map((tab, index) => (
            <div
              ...
              className={cn(
                ...
                {
                  "text-primary border-b-primary": tab === selectedTab,
                },
              )}
            >
                  ...
                  <div className="flex flex-col gap-2">
                        ...
                        <div>
                          {!!issues?.length && (
                            <button
                              ...
                              className="border-primary text-primary h-6 cursor-pointer rounded-full border px-2 text-xs"
                            >
                              Accept All
                            </button>
                          )}
                    ...
                    {!!recommendations?.length && (
                      <div className="flex items-center justify-between gap-4 rounded-md border px-4 py-2">
                        ...
                        <div>
                          {!!recommendations?.length && (
                            <button className="border-primary text-primary h-6 cursor-pointer rounded-full border px-4 text-xs">
                              Accept All
                            </button>
                          )}
                        </div>
