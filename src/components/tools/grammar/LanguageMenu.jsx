        ...
        <TabsList className="border-border flex-nowrap overflow-x-auto rounded-b-none bg-transparent p-0 whitespace-nowrap">
          {displayTabs.map((tab) => (
            <TabsTrigger
              ...
              value={tab}
              disabled={isLoading}
              className="text-muted-foreground hover:text-foreground data-[state=active]:border-border data-[state=active]:bg-card data-[state=active]:text-foreground px-3 py-4 data-[state=active]:rounded-t-lg data-[state=active]:rounded-b-none data-[state=active]:border"
            >
              {tab}
            </TabsTrigger>
          ))}
